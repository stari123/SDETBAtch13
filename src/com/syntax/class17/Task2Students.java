...
Print out  total number of students
    */
    ...
    public static void main(String[] args) {
        ...
        Task2Students task2Students3=new Task2Students();
        task2Students3.name="veli009";
        task2Students3.id="ad123";
        numberOfStudents=3;
        System.out.println(task2Students3.name);
        System.out.println(task2Students3.id);
        System.out.println(numberOfStudents);
